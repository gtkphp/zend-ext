 ...
 */
class AnnotationDocBook extends AbstractDocBook
{
    ...
    static public function Factory($acronym, $parent)
    {
        $type = -1;
        $annotation = null;
        switch ($acronym) {
        ...
        if ($type>0) {
            $annotation = new AnnotationDocBook($parent);
            $annotation->name = $acronym;
