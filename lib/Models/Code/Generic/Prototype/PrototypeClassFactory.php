...
namespace Zend\Ext\Models\Code\Generic\Prototype;

use Zend\Ext\Models\Code\Reflection\Exception;
...
class PrototypeClassFactory
{
     ...
     * @param \Laminas\Code\Generic\Prototype\PrototypeInterface $prototype
     */
    public function addPrototype($prototype): void
    {
    ...
    /**
     * @throws Exception\InvalidArgumentException
     * @param \Laminas\Code\Generic\Prototype\PrototypeGenericInterface $prototype
     */
    public function setGenericPrototype($prototype): void
    {
