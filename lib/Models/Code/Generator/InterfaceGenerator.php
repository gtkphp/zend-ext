...
class InterfaceGenerator extends ClassGenerator
{
     ...
     *
     * @return static
     * @param \Laminas\Code\Reflection\ClassReflection $classReflection
     */
    public static function fromReflection($classReflection)
    {
    ...
    /** @inheritDoc
     * @param \Laminas\Code\Generator\PropertyGenerator $property */
    public function addPropertyFromGenerator($property)
    {
        return $this;
    }

    /** @inheritDoc
     * @param \Laminas\Code\Generator\MethodGenerator $method */
    public function addMethodFromGenerator($method)
    {
