...
final class AtomicType
{
     ...
     */
    public const BUILT_IN_TYPES_PRECEDENCE = [
        'bool'     => 1,
        'int'      => 2,
        'float'    => 3,
        'string'   => 4,
    ...
    /** @throws InvalidArgumentException
     * @param $this|\Laminas\Code\Generator\TypeGenerator\IntersectionType $other */
    public function assertCanUnionWith($other): void
    {
