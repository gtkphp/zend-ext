...
class ClassGenerator extends AbstractGenerator implements TraitUsageInterface
{
    ...
    protected $destroy_functions = [];
    public function setDestroyFunction($name) {
        $this->destroy_functions[] = $name;
        return $this;
    }
    public function getDestroyFunctions() {
        return $this->destroy_functions;
    }
    protected $creator_functions = [];
    public function setCreatorFunction($name) {
        $this->creator_functions[] = $name;
        return $this;
    }
    public function getCreatorFunctions() {
        return $this->creator_functions;
    }
    ...
    public function hasImplementedInterface($implementedInterface)
    {
        ...
        return (bool) array_filter(
            ...
            function(TypeGenerator $interface) use ($interfaceType) { return $interfaceType->equals($interface);}
        );
    }
    ...
    public function removeImplementedInterface($implementedInterface)
    {
        ...
        $this->implementedInterfaces = array_filter(
            ...
            function(string $interface) use($interfaceType) { return ! TypeGenerator::fromTypeString($interface)->equals($interfaceType);}
        );
