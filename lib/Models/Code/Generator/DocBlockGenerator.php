...
use Zend\Ext\Models\Code\Generator\DocBlock\Tag;
use Zend\Ext\Models\Code\Generator\DocBlock\Tag\TagInterface;
use Zend\Ext\Models\Code\Generator\DocBlock\TagManager;
use Zend\Ext\Models\Code\Reflection\DocBlockReflection;
...
class DocBlockGenerator extends AbstractGenerator
{
    ...
    /**
     * @var \Laminas\Code\Generator\DocBlock\TagManager|null
     */
     ...
     * @param \Laminas\Code\Reflection\DocBlockReflection $reflectionDocBlock
     */
    public static function fromReflection($reflectionDocBlock)
    {
        $docBlock = new static();
