...
{
    public const POO_NONE = 0x00;
    public const POO_METHOD = 0x01;
    public const POO_VIRTUAL = 0x02;
    
    // TODO: create: public mixed $user_data;
    /**
     * @var int
     */
    protected $oo = self::POO_NONE;
    /**
     * 
     */
    ...
    public function isMemoryManagement() {
        return $this->is_mm;
    }
    protected $is_em = false;
    public function setErrorManagement($is_em=true) {
        $this->is_em = $is_em;
    }
    public function isErrorManagement() {
        return $this->is_em;
    }
    protected $is_ud = false;
    public function setUserData($is_ud=true) {
        $this->is_ud = $is_ud;
    }
    public function isUserData() {
        return $this->is_ud;
    }
    protected $is_gs = false;
    public function setGetterSetter($is_gs=true) {
        $this->is_gs = $is_gs;
    }
    public function isGetterSetter() {
        return $this->is_gs;
    }
    ...
    /**
     * @param string|TypeGenerator|null $returnType
     * @return MethodGenerator
     */
    public function setReturnType($returnType = null)
    {
        if($returnType instanceof TypeGenerator) {
    ...
    private function sortParameters(): void
    {
        uasort(
            $this->parameters,
            function (ParameterGenerator $item1, ParameterGenerator $item2) {return $item1->getPosition() <=> $item2->getPosition();}
        );
    }
     ...
     */
    public function setVirtual(bool $isVirtual)
    {
        $this->oo |= $isVirtual ? self::POO_VIRTUAL : self::POO_NONE;
    ...
    {
        return (bool) ($this->oo & self::POO_VIRTUAL);
    }
     ...
     * @return AbstractMemberGenerator
     */
    public function setMethod(bool $isMethod)
    {
        $this->oo |= $isMethod ? self::POO_METHOD : self::POO_NONE;
    ...
    {
        return (bool) ($this->oo & self::POO_METHOD);
    }
    ...
    public function generate()
    {
        ...
        $output .= implode(', ', array_map(
            function (ParameterGenerator $parameter) { return $parameter->generate();},
            $this->getParameters()
        ));
