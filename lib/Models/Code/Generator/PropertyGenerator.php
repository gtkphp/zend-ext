...
use Zend\Ext\Models\Code\Reflection\PropertyReflection;
...
class PropertyGenerator extends AbstractMemberGenerator
{
    ...
    /**
     * @var \Laminas\Code\Generator\TypeGenerator|null
     */
    protected $type;

    /**
     * @var \Laminas\Code\Generator\PropertyValueGenerator|null
     */
    ...
    /** @return static
     * @param \Laminas\Code\Reflection\PropertyReflection $reflectionProperty */
    public static function fromReflection($reflectionProperty)
    {
        ...
        $property->setType(TypeGenerator::fromReflectionType(
            method_exists($reflectionProperty, 'getType') ? $reflectionProperty->getType() : null,
    ...
    /**
     * @param \Laminas\Code\Generator\TypeGenerator|null $type
     */
