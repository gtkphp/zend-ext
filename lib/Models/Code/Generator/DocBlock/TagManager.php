...
use Zend\Ext\Models\Code\Generic\Prototype\PrototypeClassFactory;
...
class TagManager extends PrototypeClassFactory
{
     ...
     */
    public function createTagFromReflection($reflectionTag)
    {
