...
typedef struct __GUri GUri;
typedef struct _GUriParamsIter GUriParamsIter;
typedef struct _GTimeVal GTimeVal;
typedef struct __GTreeNode GTreeNode;
...
typedef struct __GStrvBuilder GStrvBuilder;
...
GRWLockReaderLocker * g_rw_lock_reader_locker_new(GRWLock *rw_lock);
void g_rw_lock_writer_locker_free(GRWLockWriterLocker *locker);
GRWLockWriterLocker * g_rw_lock_writer_locker_new(GRWLock *rw_lock);
void g_rec_mutex_locker_free(GRecMutexLocker *locker);
GRecMutexLocker * g_rec_mutex_locker_new(GRecMutex *rec_mutex);
...
void g_assertion_message_cmpstr(const char     *domain, const char     *file, int             line, const char     *func, const char     *expr, const char     *arg1, const char     *cmp, const char     *arg2) ;
 void    g_assertion_message_cmpstrv     (const char         *domain, const char         *file, int                 line, const char         *func, const char         *expr, const char * const *arg1, const char * const *arg2, gsize               first_wrong_idx) ; GLIB_AVAILABLE_IN_ALL void    g_assertion_message_cmpnum      (const char     *domain, const char     *file, int             line, const char     *func, const char     *expr, long double     arg1, const char     *cmp, long double     arg2, char            numtype) ; GLIB_AVAILABLE_IN_ALL void    g_assertion_message_error       (const char     *domain, const char     *file, int             line, const char     *func, const char     *expr, const GError   *error, GQuark          error_domain, int             error_code) ; GLIB_AVAILABLE_IN_ALL void    g_test_add_vtable               (const char     *testpath, gsize           data_size, gconstpointer   test_data, GTestFixtureFunc  data_setup, GTestFixtureFunc  data_test, GTestFixtureFunc  data_teardown);
void g_assertion_message(const char     *domain, const char     *file, int             line, const char     *func, const char     *message) G_ANALYZER_NORETURN; GLIB_AVAILABLE_IN_ALL G_NORETURN void    g_assertion_message_expr        (const char     *domain, const char     *file, int             line, const char     *func, const char     *expr);
...
GMainContextPusher * g_main_context_pusher_new(GMainContext *main_context);
