...
//function MIN(int|float $a, int|float $b):int|float {}
//function MAX(int|float $a, int|float $b):int|float {}
//function ABS(int|float $a):int|float {}
///function CLAMP(int|float $x, int|float $low, int|float $high):int|float {}

// define gint, [2, ..., 0]
//G_STRUCT_MEMBER(gint, $myObj, 0)
//function G_STRUCT_MEMBER(string|array $member_type, object $struct_p, $struct_offset):mixed {}
...
//function G_STATIC_ASSERT($expr) {} alias of eval ?
...
//function G_GNUC_PRINTF($format_idx, $arg_idx) {} php syntax not supported
...
//function G_LIKELY($expr) {} alias eval
//function G_UNLIKELY($expr) {} alias eval
...
//function g_renew(string $struct_type, &$mem, int $n_structs) {}
...
//function g_slice_new(array|string $type):mixed {}
/*
...
/*
//////////function g_datalist_id_set_data(\GData[] $dl, \GQuark $q, $d) {}
function g_datalist_id_set_data(array $dl, \GQuark $q, $d) {}
function g_datalist_id_remove_data(array $dl, \GQuark $q) {}
function g_datalist_set_data(array $dl, $k, $d) {}
function g_datalist_set_data_full(array $dl, $k, $d, $f) {}
function g_datalist_remove_data(array $dl, $k) {}
function g_datalist_remove_no_notify(array $dl, $k) {}
